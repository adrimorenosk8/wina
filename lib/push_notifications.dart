...
Future<void> initPushNotifications({required GlobalKey<NavigatorState> navKey}) async {
  ...
  // iOS: permisos más específicos
  final settings = await fm.requestPermission(
    alert: true,
    badge: true,
    sound: true,
    provisional: false, // No provisional para mejor UX
    announcement: false,
    carPlay: false,
    criticalAlert: false,
  );
  ...
  FirebaseMessaging.onMessage.listen((msg) async {
    ...
    // iOS: manejar notificaciones en foreground
    if (Platform.isIOS) {
      if (n != null) {
        // Notificación con payload completo
        await _fln.show(
          n.hashCode,
          n.title,
          n.body,
        ...
        // Data-only con title/body en data
        await _fln.show(
          msg.hashCode,
